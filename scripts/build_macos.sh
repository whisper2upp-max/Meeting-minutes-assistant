...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.1.1" \
  "$APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 0.1.1" \
  "$APP/Contents/Info.plist" 2>/dev/null || \
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 0.1.1" \
  "$APP/Contents/Info.plist"
