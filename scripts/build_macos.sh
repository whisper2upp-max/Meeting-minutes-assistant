...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 0.1.5" \
  "$APP/Contents/Info.plist" 2>/dev/null || \
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.1.5" \
  "$APP/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 0.1.5" \
  "$APP/Contents/Info.plist" 2>/dev/null || \
